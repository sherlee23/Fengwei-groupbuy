...
class FoodOrderApp {
    ...
    async loadProducts() {
        // CORRECTED: Using the product data with stock information
        this.products = [
            { id: 1, name: '原味烤肠', price: 28, category: '烤肠系列', emoji: '🌭', stock: 45, minStock: 10 },
            { id: 2, name: '烟熏蜜汁烤肠', price: 28, category: '烤肠系列', emoji: '🌭', stock: 38, minStock: 10 },
            { id: 3, name: '法式香草烤肠', price: 28, category: '烤肠系列', emoji: '🌭', stock: 52, minStock: 10 },
            { id: 4, name: '黑胡椒烤肠', price: 28, category: '烤肠系列', emoji: '🌭', stock: 8, minStock: 10 },
            { id: 5, name: '孜然脆骨烤肠', price: 28, category: '烤肠系列', emoji: '🌭', stock: 23, minStock: 10 },
            { id: 6, name: '芝士玉米烤肠', price: 28, category: '烤肠系列', emoji: '🌭', stock: 41, minStock: 10 },
            { id: 7, name: '原味虾肠', price: 33, category: '虾肠系列', emoji: '🦐', stock: 30, minStock: 8 },
            { id: 8, name: '辣味虾肠', price: 33, category: '虾肠系列', emoji: '🦐', stock: 27, minStock: 8 },
            { id: 9, name: '原味虾饼', price: 28, category: '虾肠系列', emoji: '🍤', stock: 19, minStock: 8 },
            { id: 10, name: '玛格丽特披萨', price: 25, category: '披萨系列', emoji: '🍕', stock: 15, minStock: 5 },
            { id: 11, name: '黑椒牛肉披萨', price: 25, category: '披萨系列', emoji: '🍕', stock: 12, minStock: 5 },
            { id: 12, name: '奥尔良鸡肉披萨', price: 25, category: '披萨系列', emoji: '🍕', stock: 18, minStock: 5 },
            { id: 13, name: '双料榴莲披萨', price: 40, category: '披萨系列', emoji: '🍕', stock: 3, minStock: 3 },
            { id: 14, name: '鲜肉小笼汤包', price: 12, category: '小笼汤包系列', emoji: '🥟', stock: 60, minStock: 15 },
            { id: 15, name: '菌菇小笼汤包', price: 12, category: '小笼汤包系列', emoji: '🥟', stock: 45, minStock: 15 },
            { id: 16, name: '黑松露小笼汤包', price: 12, category: '小笼汤包系列', emoji: '🥟', stock: 20, minStock: 10 },
            { id: 17, name: '黑猪肉酥饼', price: 55, category: '酥饼系列', emoji: '🥮', stock: 8, minStock: 5 },
            { id: 18, name: '安格斯牛肉酥饼', price: 55, category: '酥饼系列', emoji: '🥮', stock: 12, minStock: 5 },
            { id: 19, name: '原味鸡排', price: 20, category: '鸡排系列', emoji: '🍗', stock: 25, minStock: 8 },
            { id: 20, name: '奥尔良鸡排', price: 20, category: '鸡排系列', emoji: '🍗', stock: 22, minStock: 8 },
            { id: 21, name: '奥尔良鸡翅', price: 25, category: '鸡翅系列', emoji: '🍗', stock: 35, minStock: 10 },
            { id: 22, name: '青花椒鸡翅', price: 25, category: '鸡翅系列', emoji: '🍗', stock: 28, minStock: 10 },
            { id: 23, name: '黑猪三丁纸皮烧卖', price: 15, category: '纸皮烧卖系列', emoji: '🥟', stock: 40, minStock: 12 },
            { id: 24, name: '黑椒牛肉纸皮烧卖', price: 15, category: '纸皮烧卖系列', emoji: '🥟', stock: 5, minStock: 12 },
            { id: 25, name: '黑猪梅菜干纸皮烧卖', price: 15, category: '纸皮烧卖系列', emoji: '🥟', stock: 32, minStock: 12 },
            { id: 26, name: '三丁芝士纸皮烧卖', price: 15, category: '纸皮烧卖系列', emoji: '🥟', stock: 0, minStock: 12 },
            { id: 27, name: '乌米腊味纸皮烧卖', price: 15, category: '纸皮烧卖系列', emoji: '🥟', stock: 18, minStock: 12 }
        ];
    }
        ...
        return `
            <div class="product ${isOutOfStock ? 'out-of-stock' : ''}" data-product-id="${product.id}">
                ...
                <div class="quantity-control">
                    <button class="quantity-btn" data-action="decrease" ${quantity === 0 ? 'disabled' : ''}>-</button>
                    <input type="number" class="quantity-input" value="${quantity}" min="0" max="${product.stock}" ${isOutOfStock ? 'disabled' : ''}>
                    <button class="quantity-btn" data-action="increase" ${quantity >= product.stock ? 'disabled' : ''}>+</button>
                </div>
            </div>`;
    }
    ...
    setupQuantityControls() {
        document.querySelectorAll('.quantity-control').forEach(control => {
            ...
            control.querySelector('.quantity-input').addEventListener('change', (e) => {
    ...
    async handleAdminExport(password) {
        const ADMIN_PASSWORD = 'fengweipaiadmin'; // WARNING: INSECURE - Should be on a server
